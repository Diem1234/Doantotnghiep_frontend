                ...
                <div className="row g-4">
                    <div className="col-12">
                        <div className="row gy-4">
                            ...
                            <div className="col-md-4">
                                <h5 className="section-title ff-secondary fw-normal text-start text-primary">Mail</h5>
                        ...
                        <div className="wow fadeInUp" data-wow-delay="0.2s">
                            <form>
                                <div className="row g-3">
                                    ...
                                    <div className="col-12">
                                        <div className="form-floating">
                                            <textarea className="form-control" placeholder="Gửi lời nhắn ở đây" id="message" style={{ height: '150px' }}></textarea>
